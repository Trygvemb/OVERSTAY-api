...
public class UserConfigurations : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder
            .Property(u => u.PersonName.FirstName)
            .HasColumnName("FirstName")
            .IsRequired()
            .HasMaxLength(100);
        builder
            .Property(u => u.PersonName.LastName)
            .HasColumnName("LastName")
            .IsRequired()
            .HasMaxLength(100);
        builder.Property(u => u.Email.Value).HasColumnName("Email").IsRequired().HasMaxLength(100);
        builder
            .Property(u => u.UserName.Value)
            .HasColumnName("UserName")
            .IsRequired()
            .HasMaxLength(100);
        builder
            .Property(u => u.Password.Value)
